        ...
        <main className="flex-1 p-6 overflow-y-auto ml-0.5 h-full bg-[#41b3a926] rounded-[7px] border border-solid border-[#ffffff33]/50">
          ...
          <div className="flex flex-wrap gap-6 mb-6">
            ...
            <div className="flex flex-col flex-grow w-full md:w-auto">
              <label className="mb-0 text-shadow-md text-gray-400 text-[16px] text-left">
                Title
              </label>
              <div className="h-[40px] bg-[#1E3249] rounded-[10px] border-[1px] border-[#6A7278]/45">
                <textarea
                  className="w-full h-full bg-transparent text-[14px] leading-6 resize-none outline-none"
            ...
            <div className="flex flex-col">
              ...
              <div className="h-full w-full md:w-[150px] bg-[#4bddb433]/50 rounded-[10px] border border-[#4bddb480]/80">
                <input
