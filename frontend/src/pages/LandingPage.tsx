            ...
            <main className="flex-1 flex flex-col lg:flex-row items-center justify-center p-8 gap-12 text-center lg:text-left">
                ...
                <div className="w-screen max-w-xl lg:max-w-2xl">
                    ...
                    <h2 className="text-5xl md:text-7xl font-bold tracking-tighter leading-tight ">
                        Code it.<br />
                        <div className="green-text-gradient">Log it.</div>
                        <div className="blue-text-gradient">Store it.</div>
                    </h2>
                ...
                {/* Right Column */}
                <div className="w-full max-w-lg -mt-40 flex flex-col items-start">
                    <span className="w-50 h-50 z-20 -mb-10 inline-block">
                            <RobotMascot />
                        </span>
                    <AnimatedTerminal />
                </div>
