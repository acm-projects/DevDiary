      ...
      <div className="h-full w-[15%] flex justify-left  flex-col items-center space-y-10  relative bg-[#011522] text-white ">
        ...
        <span className="h-115">
          ...
          <div className="flex justify-center mb-5">
            <button className="bg-gradient-to-r from-[#43B5A8] to-[#318CB1] bg-opacity-65 w-[163px] h-[39px] rounded-xl flex justify-center mb-2 hover:scale-105 ease-in-out duration-200">
              <span className="text-3xl">+ </span>
              <span className="text-l mt-2 ml-1 "> New Log</span>
            </button>
          </div>
          <button className="bg-[#244F51] bg-opacity-20 w-[163px] h-[39px] ml-1.5 mr-1.5 rounded-xl hover:scale-105 ease-in-out duration-200">
            New Project
          </button>
        </span>
        <a
